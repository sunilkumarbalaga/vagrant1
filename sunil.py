...
virat_1 = 'What are the most popular three articles of all time?'
sunil_1 = """
...
virat_2 = 'Who are the most popular article authors of all time?'
sunil_2 = """
...
virat_3 = 'On which days did more than 1% of requests lead to errors?'
sunil_3 = """
select * from (
    select a.day,
